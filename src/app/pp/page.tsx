          ...
          <article className="prose-tos mx-auto max-w-3xl space-y-12 text-[15px] leading-relaxed text-muted-foreground">
            ...
            <div>
              ...
              <ul className="mt-3 list-inside list-disc space-y-1.5 pl-1">
                ...
                <li>
                  <strong className="text-foreground">Device identifier:</strong> A random identifier (GUID) the add-on generates once on first run and stores in its <code className="rounded bg-card px-1.5 py-0.5 text-xs text-primary">PluginData</code> folder. It contains no personal or hardware information: it is <em>not</em> derived from your MAC address, serial numbers or any other property of your computer.
                </li>
                <li>
                  <strong className="text-foreground">Device report:</strong> When someone tries to use your account from a device you have not approved, you receive a Discord prompt asking whether it was you. Pressing &ldquo;report&rdquo; opens a moderation ticket, and the <em>reported</em> device uploads its diagnostics (MAC address and KSP.log) to that ticket.
                </li>
                <li>
              ...
              <div className="mt-5 rounded-xl border border-border/80 bg-card/40">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-border/40">
                    ...
                    <tr>
                      <td className="px-5 py-3 text-foreground/90">
                        Patreon Account / Subscription Status
                      </td>
                      <td className="px-5 py-3">
                        Not currently collected; the Service is free for all.
                        Would be used to verify access eligibility only if a
                        paid tier is ever introduced (we would never collect
                        or store credit card numbers, billing addresses, or
                        raw financial data)
                      </td>
                      <td className="px-5 py-3">
                        Only if a paid tier is introduced and you link a
                        Patreon account
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="px-5 py-3">
                        Helps moderators identify a device you reported as not
                        yours; collected from the <em>reported</em> device
                        only, never in the background
                      </td>
                      <td className="px-5 py-3">
                        Only during a device report
                      </td>
                    </tr>
                    <tr>
                      <td className="px-5 py-3 text-foreground/90">
            ...
            <div>
              ...
              <p className="mt-3">
                ...
                Your data is never used for advertising or profiling purposes.
            ...
            <div>
              ...
              <ul className="mt-3 list-inside list-disc space-y-1.5 pl-1">
                ...
                <li>
                  <strong className="text-foreground">Patreon</strong>: not
                  currently in use. Only if a paid access tier is ever
                  introduced would subscription status be checked to verify
            ...
            <div>
              ...
              <ul className="mt-3 list-inside list-disc space-y-1.5 pl-1">
                <li>
                  ...
                  2), never your MAC address or other hardware identifiers.
                </li>
                <li>
                  Your MAC address and KSP.log are read only in two
                  user-initiated flows: a bug report you file yourself (your
                  own log only), or a device report (the reported
                  device&apos;s MAC and log). They are never read in the
                  background.
                </li>
                <li>
            ...
            <div>
              ...
              <p className="mt-3">
                ...
                in the browser &mdash; for example the players you mark as
            ...
            <div>
              ...
              <p>
                ...
                contact us through the Discord server or at the email address
                in Section 16 and we will promptly delete it.
              </p>
            </div>
